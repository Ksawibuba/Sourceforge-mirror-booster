...
**Choose language / Wybierz język:** [English Version](#-sourceforge-mirror-booster-english) | [Wersja Polska](#-sourceforge-mirror-booster-po-polsku)
...
If u want to check all of mirrors use this command ```bash
